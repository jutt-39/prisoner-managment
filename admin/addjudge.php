...
<div class="content-wrapper">
                ...
                <div class="card-body">
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="rank"id="exampleInputEmail1" placeholder="Enter Rank">
                  </div>
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 mysqli_query($conection,"insert into judge(name,courtid,rank)values('$name','$court','$rank')");

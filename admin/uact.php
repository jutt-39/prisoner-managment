<?php
  ...
  $data=mysqli_query($conection,"select *from act where actid='$update'");
...
<div class="content-wrapper">
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 $data=mysqli_query($conection,"update  act set name='$name' where actid='$update'");
  echo "<script>window.location.href='acttable.php'</script>";

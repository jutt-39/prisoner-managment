  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="addtype.php" class="nav-link">Add Type</a>
      </li>
    </ul>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><?php echo $show['typeid']  ?>  </td>
                      <td><?php echo $show['name']  ?>  </td>
                      <td><?php echo "<a href=deltype.php?delete=$typeid>X</a>";  ?>  </td>
                      <td><?php echo "<a href=utype.php?update=$typeid>Update</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>

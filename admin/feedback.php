  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="general.php" class="nav-link"></a>
      </li>
    </ul>
                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                        ...
                        $data=mysqli_query($conection,"select *from feedback");
                        while($show=mysqli_fetch_array($data)){
                          $feedbackid=$show['feedbackid'];
                    ?>
                    <tr>
                      <td><?php echo $show['feedbackid']  ?>  </td>
                      <td><?php echo $show['username']  ?>  </td>
                      <td><?php echo $show['email']  ?>  </td>
                      <td><?php echo $show['message']  ?>  </td>
                       <td><?php echo "<a href=deletefeedback.php?delete=$feedbackid>X</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>

<?php
  ...
  $data=mysqli_query($conection,"select *from policestation where policeid='$update'");
...
<div class="content-wrapper">
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 $data=mysqli_query($conection,"update  policestation set name='$name' where policeid='$update'");
   echo "<script>window.location.href='policetable.php'</script>";

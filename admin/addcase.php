...
<div class="content-wrapper">
              ...
              <form method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="case"id="exampleInputEmail1" placeholder="Enter case">
                  </div>
 ...
 $data=mysqli_query($conection,"insert into cases(name)values('$case')");
   echo "<script>window.location.href='casetable.php'</script>";

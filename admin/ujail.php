<?php
  ...
  $data=mysqli_query($conection,"select *from jail where jailid='$update'");
...
<div class="content-wrapper">
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 mysqli_query($conection,"update  jail set name='$name' where jailid='$update'");

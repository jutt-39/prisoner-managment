...
<div class="content-wrapper">
              ...
              <form method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="court"id="exampleInputEmail1" placeholder="Enter Court Name">
                  </div>
 ...
 $data=mysqli_query($conection,"insert into court(name)values('$court')");

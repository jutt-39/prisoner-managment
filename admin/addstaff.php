...
<div class="content-wrapper">
              ...
              <form method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input  type="date" class="form-control" name="join" id="exampleInputEmail1" placeholder="Enter Join Date">
                  </div>
                  <div class="form-group">
                   ...
                   <div class="form-group">
                    <label for="exampleInputEmail1">Jail</label>
                    <select name="jail" class="form-control">
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 mysqli_query($conection,"insert into staff(name,age,joiningdate,address,jailid)values('$name','$age','$join','$address','$jailid')");

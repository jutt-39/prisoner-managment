<?php
  ...
  $data=mysqli_query($conection,"select *from judge where judgeid='$update'");
...
<div class="content-wrapper">
              ...
              <form method="POST">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="rank" value="<?php echo $show['rank']  ?>" class="form-control" id="exampleInputEmail1" placeholder="">
                  </div>  
                  <div class="form-group">
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 $data=mysqli_query($conection,"update  judge set name='$name',courtid='$courtid',rank='$rank' where judgeid='$update'");
   echo "<script>window.location.href='judgetable.php'</script>";

  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="addcourt.php" class="nav-link">Add Court </a>
      </li>
    </ul>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><?php echo $show['courtid']  ?>  </td>
                      <td><?php echo $show['name']  ?>  </td>
                       <td><?php echo "<a href=delcourt?delete=$courtid>X</a>";  ?>  </td>
                      <td><?php echo "<a href=ucourt.php?update=$courtid>Update</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>

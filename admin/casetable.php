  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="addcase.php" class="nav-link">Add case </a>
      </li>
    </ul>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><?php echo $show['caseid']  ?>  </td>
                      <td><?php echo $show['name']  ?>  </td>
                       <td><?php echo "<a href=delcase?delete=$caseid>X</a>";  ?>  </td>
                      <td><?php echo "<a href=ucase.php?update=$caseid>Update</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>

<?php
  ...
  $data=mysqli_query($conection,"select *from status where statusid='$update'");
...
<div class="content-wrapper">
 ...
 $conection=mysqli_connect('localhost','root','','prison');
 $data=mysqli_query($conection,"update  status set name='$name' where statusid='$update'");
   echo "<script>window.location.href='statustable.php'</script>";

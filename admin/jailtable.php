  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="addjail.php" class="nav-link">Add Jail </a>
      </li>
    </ul>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><?php echo $show['jailid']  ?>  </td>
                      <td><?php echo $show['name']  ?>  </td>
                      <td><?php echo "<a href=deljail.php?delete=$jailid>X</a>";  ?>  </td>
                      <td><?php echo "<a href=ujail.php?update=$jailid>Update</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>

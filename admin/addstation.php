...
<div class="content-wrapper">
              ...
              <form method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="police"id="exampleInputEmail1" placeholder="Enter Police Station Name">
                  </div>
 ...
 $data=mysqli_query($conection,"insert into policestation(name)values('$police')");

  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        ...
        <a href="addstation.php" class="nav-link">Add Police Station </a>
      </li>
    </ul>
              ...
              <div class="card-body">
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    ?>
                    <tr>
                      <td><?php echo $show['policeid']  ?>  </td>
                      <td><?php echo $show['name']  ?>  </td>
                       <td><?php echo "<a href=delpolice.php?delete=$policeid>X</a>";  ?>  </td>
                      <td><?php echo "<a href=upolice.php?update=$policeid>Update</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>

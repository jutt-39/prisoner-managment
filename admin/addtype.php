...
<div class="content-wrapper">
              ...
              <form method="POST">
                <div class="card-body">
                  <div class="form-group">
                    ...
                    <input  type="text" class="form-control" name="name" id="exampleInputEmail1" placeholder="Enter Type name">
                  </div>
 ...
 mysqli_query($conection,"insert into type(name) values('$name')");
   echo "<script>window.location.href='typetable.php'</script>";

                ...
                <table id="example1" class="table table-bordered">
                  ...
                  <tbody>
                    <?php
                        ...
                        $data=mysqli_query($conection,"select  staff.name as staff,staff.staffid,jail.name as jail,staff.age,staff.joiningdate,staff.address from staff inner join jail on staff.jailid=jail.jailid");
                    ...
                    <tr>
                      ...
                      <td><?php echo $show['joiningdate']  ?>  </td>
                      <td><?php echo $show['address']  ?>  </td>
                      <td><?php echo $show['jail']  ?>  </td>
                       <td><?php echo "<a href=delstaff.php?delete=$staffid>X</a>";  ?>  </td>
                      <td><?php echo "<a href=ustaff.php?update=$staffid>Update</a>";  ?>  </td>
                    </tr>
                  <?php  } ?>
                  </tbody>
